...
## GYBS admin dashboard
Open `admin.html` to manage submitted campaigns. The admin dashboard uses Supabase Auth and the `gybs_admins` table. See `admin-schema.sql` for the one-time RLS/admin setup.
